    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!error_signup) {
                    Intent otp_activity =new Intent(SignUp.this,OTP.class);
                    Intent login_activity =new Intent(SignUp.this,MainActivity.class);
                    AuthSignUpOptions options = AuthSignUpOptions.builder()
                            .userAttribute(AuthUserAttributeKey.email(), email_txt)
                            .build();
                    Amplify.Auth.signUp(email_txt, pass_txt, options,
                            result -> {
                                Log.i("AuthQuickStart", "Result: " + result.toString());
                                otp_activity.putExtra("username",email_txt);
